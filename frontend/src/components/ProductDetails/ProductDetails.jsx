                  ...
                  {Array(3)
                    ...
                    .map((el, i) => (
                      <p className="text-sm flex items-center gap-1" key={i}>
                        ...
                        Instant discount on first OutfitAi Pay Later order of
                        500 and above{" "}
                  ...
                  <div className="w-full mt-4 rounded-sm border flex flex-col">
                    <div className="flex justify-between items-center border-b px-6 py-4">
                      ...
                      <button
                        ...
                        disabled={!isItemInOrders || isAlreadyReviewed}
                        className={
                          isItemInOrders && !isAlreadyReviewed
                            ? "shadow bg-primary-yellow text-white px-4 py-2 rounded-sm hover:shadow-lg"
                            : "shadow cursor-not-allowed bg-primary-grey text-white px-4 py-2 rounded-sm hover:shadow-lg"
                        }
                      >
                        Rate Product
                      </button>

...
const Searchbar = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full border p-2 rounded-lg border-primary sm:w-9/12 px-1 sm:px-4 flex justify-between items-center shadow-md bg-white overflow-hidden">
